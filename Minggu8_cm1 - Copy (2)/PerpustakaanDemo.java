...
public class PerpustakaanDemo {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("6. Cari Mahasiswa berdasarkan Nama"); //modifikasi B3
            System.out.println("7. Hitung rata - rata lama Peminjaman"); //modifikasi C3
            ...
            switch (pilih) {
                ...
                case 6:
                    ...
                    dbperpus.searchByName(0, dbperpus.dataMhs.length - 1, key);
                    break;
                //modifikasi C3
                case 7:
                    System.out.println("Rata - rata lama peminjaman per mahasiswa");
                    dbperpus.avgLamaPeminjaman();
                    break;
                default:
